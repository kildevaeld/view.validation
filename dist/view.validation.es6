...
import { equal, result, triggerMethodOn, extend } from '@viewjs/utils';
import { normalizeUIKeys, View } from '@viewjs/view';
import { withModel, withBindings } from '@viewjs/data';
    ...
    return function (_Base) {
        ...
        createClass(_class, [{
            ...
            value: function _getValidations() {
                var ui = this._ui || this.ui,
                    validations = result(this, '_validations') || this.constructor.validations || {},
                    v = normalizeUIKeys(validations, ui);
                return v;
            }
        }]);
        return _class;
...
var FormView = function (_withValidation) {
    ...
    function FormView(options) {
        ...
        return possibleConstructorReturn(this, (FormView.__proto__ || Object.getPrototypeOf(FormView)).call(this, extend({
    ...
    return FormView;
}(withValidation(withBindings(withModel(View)), { event: 'keyup' }));

export { validations, withValidation, createError, ValidationError, ValidationErrors, FormView };
