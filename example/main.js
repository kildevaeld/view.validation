...
Object.defineProperty(exports, "__esModule", { value: true });
var tim_1 = __webpack_require__(12);
...
function withValidation(Base) {
    ...
    function validation_wrap(self, v) {
        return function (e) {
            ...
            var value = html_1.getValue(target);
            var valid = true;
            try {
                v.validate(value);
            ...
            utils_1.triggerMethodOn(this, 'change:value', target, value, valid);
        }.bind(self);
    }
    return function (_Base) {
        _inherits(_class, _Base);
...
(function (global, factory) {
     true ? factory(exports, __webpack_require__(0), __webpack_require__(1), __webpack_require__(4), __webpack_require__(2), __webpack_require__(8)) :
...
var Main = function (_view_1$withTemplate) {
    ...
    _createClass(Main, [{
        ...
        key: "onChangeValue",
        value: function onChangeValue(el, value, valid) {
...
var view_1 = __webpack_require__(1);
var utils_1 = __webpack_require__(0);
var validation_view_1 = __webpack_require__(5);
...
var FormView = function (_validation_view_1$wi) {
    ...
    return FormView;
}(validation_view_1.withValidation(data_1.withBindings(models_1.withModel(view_1.View)), { event: 'keyup' }));
...
Object.defineProperty(exports, "__esModule", { value: true });
var validators_1 = __webpack_require__(14);
var errors_1 = __webpack_require__(3);
